...
const LLCSearch = () => {
  ...
  return (
    <div className="mt-2">
      ...
      <p>
        Choose the right entity and start your business with confidence. We guide
        you through LLC, S-Corp, C-Corp, and Nonprofit formation.
      </p>
      <form
        className="mt-8 flex flex-col md:flex-row gap-6 items-center w-full"
        ...
        <div className="flex-2 flex flex-col relative w-full md:w-auto">
          <div className="relative w-full">
            ...
            <select
              ...
              name="state"
              className="pl-14 pr-4 py-5 border border-[#0F395D] rounded-lg text-lg w-full"
              value={selectedState} // controlled value from state
